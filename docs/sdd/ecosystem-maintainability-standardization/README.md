...
Profile: Asset repository.

Theme metadata validation and user-local installation exist, but local uninstall and system-stage validation are missing and no CI workflow currently exercises assets.
